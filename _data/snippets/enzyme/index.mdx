---
title: Enzyme Stuff
shortDescription: Miscellaneous snippets for working if you have to do tests with Enzyme
category: react
tags:
  - javascript
...
- You can't test submitting a form by clicking a button / input with `type="submit"` due to events
  not working the same in jsdom
