...
specified class on hover and focus. It also adds `hocus-within`, `group-hocus`,
...
add a [snippet for this plugin](/snippets/tailwindcss-hocus).</small>
...
I also made a secret "CMS" frontend and set up security rules so that only I can
