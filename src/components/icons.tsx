...
export const SolidJsIcon: IconComponent = props => (
  <svg viewBox="0 0 166 155.3" {...props}>
    <defs>
      <linearGradient
        id="a"
    ...
    <path
      d="M162.5 35.7S109.8-4.1 68.9 5.2c-1.2.3-2.5.6-3.6 1-6.3 2-11 5.5-13.9 9.7-.6.8-1 1.7-1.5 2.5L34.8 44.1l26.1 5.1c10.3 7.4 24.8 10.5 37.2 7.3l46.5 9.1z"
      fill="currentColor"
    />
    <path
      d="M162.5 35.7S109.8-4.1 68.9 5.2c-1.2.3-2.5.6-3.6 1-6.3 2-11 5.5-13.9 9.7-.6.8-1 1.7-1.5 2.5L34.8 44.1l26.1 5.1c10.3 7.4 24.8 10.5 37.2 7.3l46.5 9.1z"
    ...
    />
    <path
      d="M51 35.2c-1.2.3-2.5.6-3.6 1-16.7 5.4-22.4 21-12.8 34.7S65.5 91.4 82.2 86l62.4-20.2c0-.1-52.7-39.9-93.6-30.6z"
      fill="currentColor"
    />
    <path
      d="M51 35.2c-1.2.3-2.5.6-3.6 1-16.7 5.4-22.4 21-12.8 34.7S65.5 91.4 82.2 86l62.4-20.2c0-.1-52.7-39.9-93.6-30.6z"
    ...
    />
    <path
      d="M133.1 80.2c-9.6-13.7-30.9-20.5-47.6-15.1L23.1 85.3l-19.6 35 111.6 19.1 20-35.6c4-7 3.6-15.6-2-23.6z"
      fill="currentColor"
    />
    <path
      d="M113.5 115.1c-9.6-13.7-30.9-20.5-47.6-15.1L3.5 120.3s52.7 39.8 93.6 30.5c1.2-.3 2.5-.6 3.6-1 16.7-5.4 22.4-21 12.8-34.7z"
      fill="currentColor"
    />
  </svg>
)
...
export const GlobeAuIcon: IconComponent = props => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const TailwindIcon: IconComponent = props => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 260 260" {...props}>
    <path
      fill="currentColor"
      d="M110.9 54.1C95.4 58 84.1 66 75.7 78.8c-4.1 6.2-9.7 19-9.7 22.1 0 .8 2.3-1 5.1-3.8 11.7-11.8 25.1-16.2 38.8-12.6 8 2.1 12.9 5.5 25.7 18 14.7 14.2 22.4 19.5 34.5 23.7 9 3.1 10 3.2 24.9 3.2 14-.1 16.3-.3 23.5-2.7 20-6.6 33.3-21 40-43.5l1.4-4.5-6.3 6.4c-12.2 12.5-27 16.5-41.7 11.5-5.9-2-11.3-6-20.9-15.4-10.8-10.6-17.3-16.3-21-18.3-1.7-.9-3.6-2.1-4.3-2.7-2-1.7-11.9-5.1-19.2-6.7-9.5-1.9-26.5-1.7-35.6.6zM49 131.4c-23 4.6-38.1 18.3-46.2 42.1l-2.8 8 4.3-4.5c10.9-11.6 22.4-16.8 34.3-15.6 11.5 1.2 16.4 4 30.4 17.6 13.4 13 19.6 17.8 27.7 21.8 11.2 5.4 17.4 6.6 33.8 6.6 13.5 0 15.8-.3 23.1-2.7 18.7-6.2 31.2-18.9 38.3-39.2l3.2-8.9-5.5 5.6c-11.9 12.3-25.6 17-39.2 13.4-9.3-2.5-11.4-3.9-26.8-18.9-20.3-19.8-32.6-25.6-55.6-26.2-7.8-.3-15 .1-19 .9z"
    />
  </svg>
)
