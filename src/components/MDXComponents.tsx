  ...
  return (
    <div className="relative p-4 rounded ring-2 ring-drac-purple my-[1.7em]">
      <div className="flex justify-between mb-2 text-sm font-bold tracking-wide uppercase font-display ">
        ...
        <button
          className="px-2 font-bold tracking-wide rounded text-drac-bg bg-drac-purple focus:ring-offset-current focus:ring-2 focus:ring-offset-2 focus:ring-drac-purple focus:outline-none"
          onClick={async event => {
