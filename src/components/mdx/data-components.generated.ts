import * as EventDelegation from '~data/blog/event-delegation/components'
import * as PromiseAll from '~data/blog/promise-all/components'
import * as CreatePreviousMemo from '~data/snippets/create-previous-memo/components'
...
export const dataComponents = {
  'blog/event-delegation': EventDelegation,
  'blog/promise-all': PromiseAll,
  'snippets/create-previous-memo': CreatePreviousMemo,
