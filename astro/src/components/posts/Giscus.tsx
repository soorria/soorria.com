...
const theme =
  typeof window !== 'undefined' && window.location.hostname === 'localhost'
    ? 'http://localhost:4321/giscus.css'
...
export default function Giscus({ dataType, slug }: GiscusProps) {
  ...
  const iframeSrc = useMemo(() => {
    ...
    const backLink = getDeployedPageUrl().toString()
