...
import { MagicSprinkles } from './_magic-sprinkles.component'
      ...
      {hydrated && (
        <>
          {showHeading && (
            <>
              <div
                ...
                style={{ '--step-delay': '750ms', '--slide-duration': '1s' } as React.CSSProperties}
              >
          ...
          <div
            ...
            style={{ '--initial-step': '4' } as React.CSSProperties}
          >
            <button
              className={cx(
